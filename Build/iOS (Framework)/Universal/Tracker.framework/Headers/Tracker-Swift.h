...
- (void)getUserAgentAsyncWithCompletionHandler:(void (^ _Nonnull)(NSString * _Nonnull))completionHandler;
@property (nonatomic, copy) NSString * _Nonnull applicationVersion;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSURL * _Nonnull databaseDirectory;)
+ (NSURL * _Nonnull)databaseDirectory SWIFT_WARN_UNUSED_RESULT;
+ (void)setDatabaseDirectory:(NSURL * _Nonnull)newValue;
/// Disable user identification.
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) BOOL optOut;)
+ (BOOL)optOut SWIFT_WARN_UNUSED_RESULT;
+ (void)setOptOut:(BOOL)newValue;
/// Prevent offline hits to be sync with icloud
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) BOOL preventICloudSync;)
+ (BOOL)preventICloudSync SWIFT_WARN_UNUSED_RESULT;
+ (void)setPreventICloudSync:(BOOL)value;
...
/// Actions
typedef SWIFT_ENUM(NSInteger, ScreenAction, closed) {
/// view actions
  ScreenActionView = 0,
};


SWIFT_CLASS("_TtC7Tracker5Event")
...
SWIFT_CLASS("_TtC7Tracker10AddProduct")
@interface AddProduct : Event
/// Product property
@property (nonatomic, strong) ECommerceProduct * _Nonnull product;
/// Cart property
@property (nonatomic, strong) ECommerceCart * _Nonnull cart;
@end


SWIFT_CLASS("_TtC7Tracker12EventsHelper")
...
SWIFT_CLASS("_TtC7Tracker11AddProducts")
@interface AddProducts : EventsHelper
/// Add add product event tracking
///
/// returns:
/// AddProduct instance
- (AddProduct * _Nonnull)add SWIFT_WARN_UNUSED_RESULT;
@end
...
/// Media name
@property (nonatomic, copy) NSString * _Nonnull name SWIFT_DEPRECATED_MSG("", "mediaLabel");
/// Media name
@property (nonatomic, copy) NSString * _Nonnull mediaLabel;
/// First chapter
@property (nonatomic, copy) NSString * _Nullable chapter1 SWIFT_DEPRECATED_MSG("", "mediaTheme1");
/// First chapter
@property (nonatomic, copy) NSString * _Nullable mediaTheme1;
/// Second chapter
@property (nonatomic, copy) NSString * _Nullable chapter2 SWIFT_DEPRECATED_MSG("", "mediaTheme2");
/// Second chapter
@property (nonatomic, copy) NSString * _Nullable mediaTheme2;
/// Third chapter
@property (nonatomic, copy) NSString * _Nullable chapter3 SWIFT_DEPRECATED_MSG("", "mediaTheme3");
/// Third chapter
@property (nonatomic, copy) NSString * _Nullable mediaTheme3;
/// Level 2
@property (nonatomic) NSInteger level2 SWIFT_DEPRECATED_MSG("", "mediaLevel2");
/// Level 2
@property (nonatomic) NSInteger mediaLevel2;
/// Duration
@property (nonatomic) NSInteger duration;
/// Action. see RichMediaAction
@property (nonatomic) enum RichMediaAction action SWIFT_DEPRECATED_MSG("useless, property set when send called");
/// Web domain
@property (nonatomic, copy) NSString * _Nullable webdomain;
/// Linked Content
@property (nonatomic, copy) NSString * _Nullable linkedContent;
/// Send a play action tracking. Refresh is enabled with default refresh configuration. See doc for more details
- (void)sendPlay;
/// Send a play action tracking. Refresh is enabled with default refresh configuration. See doc for more details
- (void)sendPlayWithIsBuffering:(BOOL)isBuffering;
/// Send a play action tracking. Refresh is enabled with custom duration
/// \param refreshDuration duration in second, must be >= 5
///
- (void)sendPlay:(NSInteger)refreshDuration SWIFT_DEPRECATED_MSG("Static values are not recomanded anymore. Use sendPlay() or sendPlay(dynamicRefreshConfiguration)");
/// Send a play action. No refresh hits will be sent after the action.
- (void)sendPlayWithoutRefresh;
/// Send a play action. No refresh hits will be sent after the action.
- (void)sendPlayWithoutRefreshWithIsBuffering:(BOOL)isBuffering;
/// Send a Play action then send several Resfresh action based on the configuration provided
/// \param dynamicRefreshConfiguration Describe the refresh send rate: [0:5, 1:10] : from 0 to 1 minute, send one refresh every 5s, then refresh every 10s after 1min. See documentation for more details.
///
- (void)sendPlayWithDynamicRefreshConfiguration:(NSDictionary<NSNumber *, NSNumber *> * _Nonnull)dynamicRefreshConfiguration;
/// Send a Play action then send several Resfresh action based on the configuration provided
/// \param dynamicRefreshConfiguration Describe the refresh send rate: [0:5, 1:10] : from 0 to 1 minute, send one refresh every 5s, then refresh every 10s after 1min. See documentation for more details.
///
- (void)sendPlayWithDynamicRefreshConfiguration:(NSDictionary<NSNumber *, NSNumber *> * _Nonnull)dynamicRefreshConfiguration isBuffering:(BOOL)isBuffering;
/// Resume a previous pause() call
- (void)sendResume;
/// Resume a previous pause() call
- (void)sendResumeWithIsBuffering:(BOOL)isBuffering;
/// Send a info action tracking
- (void)sendInfo;
/// Send a info action tracking
- (void)sendInfoWithIsBuffering:(BOOL)isBuffering;
...
///   </li>
/// </ul>
typedef SWIFT_ENUM(NSInteger, BroadcastMode, closed) {
/// clip
  BroadcastModeClip = 0,
/// live
  BroadcastModeLive = 1,
...
///   </li>
/// </ul>
typedef SWIFT_ENUM(NSInteger, RichMediaAction, closed) {
/// play
...
/// info
  RichMediaActionInfo = 5,
/// share
  RichMediaActionShare = 6,
/// email
  RichMediaActionEmail = 7,
/// favor
  RichMediaActionFavor = 8,
/// download
  RichMediaActionDownload = 9,
};
...
- (Audio * _Nonnull)add:(NSString * _Nonnull)mediaLabel duration:(NSInteger)duration SWIFT_WARN_UNUSED_RESULT;
/// Add a new Audio
...
/// returns:
/// the new Audio instance
- (Audio * _Nonnull)add:(NSString * _Nonnull)name chapter1:(NSString * _Nonnull)chapter1 duration:(NSInteger)duration SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_MSG("", "add(mediaLabel:mediaTheme1:duration:)");
/// Add a new Audio
/// \param mediaLabel audio name
///
/// \param mediaTheme1 audio first chapter
///
/// \param duration duration of the track in second
///
///
/// returns:
/// the new Audio instance
- (Audio * _Nonnull)add:(NSString * _Nonnull)mediaLabel mediaTheme1:(NSString * _Nonnull)mediaTheme1 duration:(NSInteger)duration SWIFT_WARN_UNUSED_RESULT;
/// Add a new Audio
/// \param name audio name
///
/// \param chapter1 audio first chapter
...
/// returns:
/// the new Audio instance
- (Audio * _Nonnull)add:(NSString * _Nonnull)name chapter1:(NSString * _Nonnull)chapter1 chapter2:(NSString * _Nonnull)chapter2 duration:(NSInteger)duration SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_MSG("", "add(mediaLabel:mediaTheme1:mediaTheme2:duration:)");
/// Add a new Audio
/// \param mediaLabel audio name
///
/// \param mediaTheme1 audio first chapter
///
/// \param mediaTheme2 audio second chapter
///
/// \param duration duration of the track in second
///
///
/// returns:
/// the new Audio instance
- (Audio * _Nonnull)add:(NSString * _Nonnull)mediaLabel mediaTheme1:(NSString * _Nonnull)mediaTheme1 mediaTheme2:(NSString * _Nonnull)mediaTheme2 duration:(NSInteger)duration SWIFT_WARN_UNUSED_RESULT;
/// Add a new Audio
/// \param name audio name
///
/// \param chapter1 audio first chapter
...
/// returns:
/// the new Audio instance
- (Audio * _Nonnull)add:(NSString * _Nonnull)name chapter1:(NSString * _Nonnull)chapter1 chapter2:(NSString * _Nonnull)chapter2 chapter3:(NSString * _Nonnull)chapter3 duration:(NSInteger)duration SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_MSG("", "add(mediaLabel:mediaTheme1:mediaTheme2:mediaTheme3:duration:)");
/// Add a new Audio
/// \param mediaLabel audio name
///
/// \param mediaTheme1 audio first chapter
...
/// \param mediaTheme2 audio second chapter
///
/// \param mediaTheme3 audio third chapter
///
/// \param duration duration of the track in second
///
///
/// returns:
/// the new Audio instance
- (Audio * _Nonnull)add:(NSString * _Nonnull)mediaLabel mediaTheme1:(NSString * _Nonnull)mediaTheme1 mediaTheme2:(NSString * _Nonnull)mediaTheme2 mediaTheme3:(NSString * _Nonnull)mediaTheme3 duration:(NSInteger)duration SWIFT_WARN_UNUSED_RESULT;
/// Remove an audio by name
/// \param mediaLabel audio identified by name
///
- (void)remove:(NSString * _Nonnull)mediaLabel;
/// Remove all audios
- (void)removeAll;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
...
///   </li>
/// </ul>
typedef SWIFT_ENUM(NSInteger, BackgroundMode, closed) {
/// normal: tracking in foreground
...
SWIFT_CLASS("_TtC7Tracker19CartAwaitingPayment")
@interface CartAwaitingPayment : Event
/// Cart property
@property (nonatomic, strong) ECommerceCart * _Nonnull cart;
/// Products list
@property (nonatomic, copy) NSArray<ECommerceProduct *> * _Nonnull products;
/// Transaction property
@property (nonatomic, strong) ECommerceTransaction * _Nonnull transaction;
/// Shipping property
@property (nonatomic, strong) ECommerceShipping * _Nonnull shipping;
/// Payment property
@property (nonatomic, strong) ECommercePayment * _Nonnull payment;
- (void)setProductsWithProducts:(NSArray<ECommerceProduct *> * _Nonnull)products;
@end

@class Screen;

/// Wrapper class to manage UpdateCart event instances
SWIFT_CLASS("_TtC7Tracker20CartAwaitingPayments")
@interface CartAwaitingPayments : EventsHelper
/// Add cart awaiting payment event tracking
///
/// returns:
/// CartAwaitingPayment instance
- (CartAwaitingPayment * _Nonnull)add SWIFT_WARN_UNUSED_RESULT;
/// Add cart awaiting payment event tracking
/// \param screenLabel a screen label
///
///
/// returns:
/// CartAwaitingPayment instance
- (CartAwaitingPayment * _Nonnull)addWithScreenLabel:(NSString * _Nullable)screenLabel SWIFT_WARN_UNUSED_RESULT;
/// Add cart awaiting payment event tracking
...
/// returns:
/// CartAwaitingPayment instance
- (CartAwaitingPayment * _Nonnull)addWithScreen:(Screen * _Nullable)screen SWIFT_WARN_UNUSED_RESULT;
@end
...
///   </li>
/// </ul>
typedef SWIFT_ENUM(NSInteger, CustomVarType, closed) {
/// app
  CustomVarTypeApp = 0,
/// screen
...
SWIFT_CLASS("_TtC7Tracker16DeliveryCheckout")
@interface DeliveryCheckout : Event
/// Cart property
@property (nonatomic, strong) ECommerceCart * _Nonnull cart;
/// Shipping property
@property (nonatomic, strong) ECommerceShipping * _Nonnull shipping;
...
SWIFT_CLASS("_TtC7Tracker17DeliveryCheckouts")
@interface DeliveryCheckouts : EventsHelper
/// Add click product event tracking
///
/// returns:
/// DeliveryCheckout instance
- (DeliveryCheckout * _Nonnull)add SWIFT_WARN_UNUSED_RESULT;
@end


/// Wrapper class for DisplayCart event tracking (SalesInsight)
SWIFT_CLASS("_TtC7Tracker11DisplayCart")
@interface DisplayCart : Event
/// Products list
@property (nonatomic, copy) NSArray<ECommerceProduct *> * _Nonnull products;
/// Cart property
@property (nonatomic, strong) ECommerceCart * _Nonnull cart;
...
SWIFT_CLASS("_TtC7Tracker12DisplayCarts")
@interface DisplayCarts : EventsHelper
/// Add display cart event tracking
///
/// returns:
/// DisplayCart instance
- (DisplayCart * _Nonnull)add SWIFT_WARN_UNUSED_RESULT;
/// Add display cart event tracking
/// \param screenLabel a screen label
///
///
/// returns:
/// DisplayCart instance
- (DisplayCart * _Nonnull)addWithScreenLabel:(NSString * _Nullable)screenLabel SWIFT_WARN_UNUSED_RESULT;
/// Add display cart event tracking
/// \param screen a screen instance
///
///
/// returns:
/// DisplayCart instance
- (DisplayCart * _Nonnull)addWithScreen:(Screen * _Nullable)screen SWIFT_WARN_UNUSED_RESULT;
@end


/// Wrapper class for DisplayPageProduct event tracking (SalesInsight)
SWIFT_CLASS("_TtC7Tracker18DisplayPageProduct")
@interface DisplayPageProduct : Event
/// Product property
@property (nonatomic, strong) ECommerceProduct * _Nonnull product;
@end
...
SWIFT_CLASS("_TtC7Tracker19DisplayPageProducts")
@interface DisplayPageProducts : EventsHelper
/// Add display page product event tracking
///
/// returns:
/// DisplayPageProduct instance
- (DisplayPageProduct * _Nonnull)add SWIFT_WARN_UNUSED_RESULT;
/// Add display page product event tracking
/// \param screenLabel a screen label
///
///
/// returns:
/// DisplayPageProduct instance
- (DisplayPageProduct * _Nonnull)addWithScreenLabel:(NSString * _Nullable)screenLabel SWIFT_WARN_UNUSED_RESULT;
/// Add display page product event tracking
/// \param screen a screen instance
///
///
/// returns:
/// DisplayPageProduct instance
- (DisplayPageProduct * _Nonnull)addWithScreen:(Screen * _Nullable)screen SWIFT_WARN_UNUSED_RESULT;
@end


/// Wrapper class for DisplayPageProduct event tracking (SalesInsight)
SWIFT_CLASS("_TtC7Tracker14DisplayProduct")
@interface DisplayProduct : Event
/// List property
@property (nonatomic, copy) NSArray<ECommerceProduct *> * _Nonnull products;
- (void)setProductsWithProducts:(NSArray<ECommerceProduct *> * _Nonnull)products;
@end
...
SWIFT_CLASS("_TtC7Tracker15DisplayProducts")
@interface DisplayProducts : EventsHelper
/// Add display products event tracking
///
/// returns:
/// DisplayProduct instance
- (DisplayProduct * _Nonnull)add SWIFT_WARN_UNUSED_RESULT;
@end
...
@class UpdateCarts;
@class PaymentCheckouts;
@class TransactionConfirmations;

SWIFT_CLASS("_TtC7Tracker9ECommerce")
@interface ECommerce : NSObject
@property (nonatomic, strong) DisplayPageProducts * _Nonnull displayPageProducts;
@property (nonatomic, strong) DisplayProducts * _Nonnull displayProducts;
@property (nonatomic, strong) AddProducts * _Nonnull addProducts;
@property (nonatomic, strong) RemoveProducts * _Nonnull removeProducts;
@property (nonatomic, strong) DisplayCarts * _Nonnull displayCarts;
@property (nonatomic, strong) UpdateCarts * _Nonnull updateCarts;
@property (nonatomic, strong) DeliveryCheckouts * _Nonnull deliveryCheckouts;
@property (nonatomic, strong) PaymentCheckouts * _Nonnull paymentCheckouts;
@property (nonatomic, strong) CartAwaitingPayments * _Nonnull cartAwaitingPayments;
@property (nonatomic, strong) TransactionConfirmations * _Nonnull transactionConfirmations;
...
///
- (void)setAutoSalesTrackerEnabled:(BOOL)enabled sync:(BOOL)sync completionHandler:(void (^ _Nullable)(BOOL))completionHandler;
...
/// \param completionHandler called when the operation has been done
///
- (void)setCollectDomain:(NSString * _Nonnull)domain sync:(BOOL)sync completionHandler:(void (^ _Nullable)(BOOL))completionHandler SWIFT_DEPRECATED_MSG("since 2.16.0, default log domain used");
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC7Tracker28RequiredPropertiesDataObject")
@interface RequiredPropertiesDataObject : NSObject
- (RequiredPropertiesDataObject * _Nonnull)setWithKey:(NSString * _Nonnull)key value:(id _Nonnull)value SWIFT_WARN_UNUSED_RESULT;
- (RequiredPropertiesDataObject * _Nonnull)setAllWithObj:(NSDictionary<NSString *, id> * _Nonnull)obj SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC7Tracker13ECommerceCart")
@interface ECommerceCart : RequiredPropertiesDataObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC7Tracker16ECommercePayment")
@interface ECommercePayment : RequiredPropertiesDataObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC7Tracker16ECommerceProduct")
@interface ECommerceProduct : RequiredPropertiesDataObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
- (nonnull instancetype)initWithObj:(NSDictionary<NSString *, id> * _Nonnull)obj;
@end


SWIFT_CLASS("_TtC7Tracker17ECommerceShipping")
@interface ECommerceShipping : RequiredPropertiesDataObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC7Tracker20ECommerceTransaction")
@interface ECommerceTransaction : RequiredPropertiesDataObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC7Tracker6Events")
@interface Events : BusinessObject
/// Add an event
/// \param name event type label
///
...
/// returns:
/// a new Event
- (Event * _Nonnull)addWithName:(NSString * _Nonnull)name data:(NSDictionary<NSString *, id> * _Nonnull)data SWIFT_WARN_UNUSED_RESULT;
/// Add an event
/// \param event event instance
///
///
/// returns:
/// the event instance added
- (Event * _Nonnull)addWithEvent:(Event * _Nonnull)event SWIFT_WARN_UNUSED_RESULT;
...
///   </li>
/// </ul>
typedef SWIFT_ENUM(NSInteger, GestureEventType, closed) {
/// <ul>
///   <li>
///     unknown: unknown
///   </li>
...
///   </li>
/// </ul>
typedef SWIFT_ENUM(NSInteger, GestureAction, closed) {
/// <ul>
///   <li>
///     touch: simple gesture
///   </li>
...
///   </li>
/// </ul>
typedef SWIFT_ENUM(NSInteger, HitType, closed) {
  HitTypeUnknown = 0,
/// screen
  HitTypeScreen = 1,
/// touch
...
///   </li>
/// </ul>
typedef SWIFT_ENUM(NSInteger, HitStatus, closed) {
/// failed
  HitStatusFailed = 0,
/// success
  HitStatusSuccess = 1,
...
- (LiveAudio * _Nonnull)add:(NSString * _Nonnull)mediaLabel SWIFT_WARN_UNUSED_RESULT;
/// Add a new live audio
/// \param name name
///
/// \param chapter1 chapter1 label
...
/// returns:
/// new live audio instance
- (LiveAudio * _Nonnull)add:(NSString * _Nonnull)name chapter1:(NSString * _Nonnull)chapter1 SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_MSG("", "add(mediaLabel:mediaTheme1:)");
/// Add a new live audio
/// \param mediaLabel name
///
/// \param mediaTheme1 chapter1 label
///
///
/// returns:
/// new live audio instance
- (LiveAudio * _Nonnull)add:(NSString * _Nonnull)mediaLabel mediaTheme1:(NSString * _Nonnull)mediaTheme1 SWIFT_WARN_UNUSED_RESULT;
/// Add a new live audio
/// \param name name
///
/// \param chapter1 chapter1 label
...
- (LiveAudio * _Nonnull)add:(NSString * _Nonnull)name chapter1:(NSString * _Nonnull)chapter1 chapter2:(NSString * _Nonnull)chapter2 SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_MSG("", "add(mediaLabel:mediaTheme1:mediaTheme2:)");
/// Add a new live audio
/// \param mediaLabel name
///
/// \param mediaTheme1 chapter1 label
///
/// \param mediaTheme2 chapter2 label
///
///
/// returns:
/// a new live audio instance
- (LiveAudio * _Nonnull)add:(NSString * _Nonnull)mediaLabel mediaTheme1:(NSString * _Nonnull)mediaTheme1 mediaTheme2:(NSString * _Nonnull)mediaTheme2 SWIFT_WARN_UNUSED_RESULT;
/// Add a new live audio
/// \param name name
///
/// \param chapter1 chapter1 label
...
/// returns:
/// a new live audio instance
- (LiveAudio * _Nonnull)add:(NSString * _Nonnull)name chapter1:(NSString * _Nonnull)chapter1 chapter2:(NSString * _Nonnull)chapter2 chapter3:(NSString * _Nonnull)chapter3 SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_MSG("", "add(mediaLabel:mediaTheme1:mediaTheme2:mediaTheme3:)");
/// Add a new live audio
/// \param mediaLabel name
///
/// \param mediaTheme1 chapter1 label
...
/// \param mediaTheme2 chapter2 label
///
/// \param mediaTheme3 chapter3 label
///
///
/// returns:
/// a new live audio instance
- (LiveAudio * _Nonnull)add:(NSString * _Nonnull)mediaLabel mediaTheme1:(NSString * _Nonnull)mediaTheme1 mediaTheme2:(NSString * _Nonnull)mediaTheme2 mediaTheme3:(NSString * _Nonnull)mediaTheme3 SWIFT_WARN_UNUSED_RESULT;
/// Remove a live audio
/// \param mediaLabel name
///
- (void)remove:(NSString * _Nonnull)mediaLabel;
...
/// Wrapper class to manage LiveAudio instances
SWIFT_CLASS("_TtC7Tracker9LiveMedia")
@interface LiveMedia : NSObject
/// Add a new live medium
/// \param mediaLabel medium name
///
///
/// returns:
/// new live medium instance
- (LiveMedium * _Nonnull)add:(NSString * _Nonnull)mediaLabel mediaType:(NSString * _Nonnull)mediaType SWIFT_WARN_UNUSED_RESULT;
/// Add a new live medium
/// \param mediaLabel name
///
/// \param mediaTheme1 chapter1 label
...
/// returns:
/// new live medium instance
- (LiveMedium * _Nonnull)add:(NSString * _Nonnull)mediaLabel mediaTheme1:(NSString * _Nonnull)mediaTheme1 mediaType:(NSString * _Nonnull)mediaType SWIFT_WARN_UNUSED_RESULT;
/// Add a new live medium
/// \param mediaLabel name
///
/// \param mediaTheme1 chapter1 label
...
///
/// returns:
/// a new live medium instance
- (LiveMedium * _Nonnull)add:(NSString * _Nonnull)mediaLabel mediaTheme1:(NSString * _Nonnull)mediaTheme1 mediaTheme2:(NSString * _Nonnull)mediaTheme2 mediaType:(NSString * _Nonnull)mediaType SWIFT_WARN_UNUSED_RESULT;
/// Add a new live medium
/// \param mediaLabel name
///
/// \param mediaTheme1 chapter1 label
...
/// returns:
/// a new live medium instance
- (LiveMedium * _Nonnull)add:(NSString * _Nonnull)mediaLabel mediaTheme1:(NSString * _Nonnull)mediaTheme1 mediaTheme2:(NSString * _Nonnull)mediaTheme2 mediaTheme3:(NSString * _Nonnull)mediaTheme3 mediaType:(NSString * _Nonnull)mediaType SWIFT_WARN_UNUSED_RESULT;
...
/// Wrapper class for live audio tracking
SWIFT_CLASS("_TtC7Tracker10LiveMedium")
@interface LiveMedium : RichMedia
@end
...
/// \param mediaLabel live name
///
///
/// returns:
/// the new live video instance
- (LiveVideo * _Nonnull)add:(NSString * _Nonnull)mediaLabel SWIFT_WARN_UNUSED_RESULT;
/// Add a new live video
/// \param name name
///
/// \param chapter1 chapter1 label
...
- (LiveVideo * _Nonnull)add:(NSString * _Nonnull)name chapter1:(NSString * _Nonnull)chapter1 SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_MSG("", "add(mediaLabel:mediaTheme1:)");
/// Add a new live video
/// \param mediaLabel name
///
/// \param mediaTheme1 chapter1 label
...
/// returns:
/// a new live video instance
- (LiveVideo * _Nonnull)add:(NSString * _Nonnull)mediaLabel mediaTheme1:(NSString * _Nonnull)mediaTheme1 SWIFT_WARN_UNUSED_RESULT;
/// Add a new live video
/// \param name name
///
/// \param chapter1 chapter1 label
...
/// returns:
/// the new live video instance
- (LiveVideo * _Nonnull)add:(NSString * _Nonnull)name chapter1:(NSString * _Nonnull)chapter1 chapter2:(NSString * _Nonnull)chapter2 SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_MSG("", "add(mediaLabel:mediaTheme1:mediaTheme2:)");
/// Add a new live video
/// \param mediaLabel name
///
/// \param mediaTheme1 chapter1 label
...
/// returns:
/// the new live video instance
- (LiveVideo * _Nonnull)add:(NSString * _Nonnull)mediaLabel mediaTheme1:(NSString * _Nonnull)mediaTheme1 mediaTheme2:(NSString * _Nonnull)mediaTheme2 SWIFT_WARN_UNUSED_RESULT;
/// Add a new live video
/// \param name name
///
/// \param chapter1 chapter1 label
...
/// returns:
/// a new live video instance
- (LiveVideo * _Nonnull)add:(NSString * _Nonnull)name chapter1:(NSString * _Nonnull)chapter1 chapter2:(NSString * _Nonnull)chapter2 chapter3:(NSString * _Nonnull)chapter3 SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_MSG("", "add(mediaLabel:mediaTheme1:mediaTheme2:mediaTheme3:)");
/// Add a new live video
/// \param mediaLabel name
///
/// \param mediaTheme1 chapter1 label
...
/// returns:
/// a new live video instance
- (LiveVideo * _Nonnull)add:(NSString * _Nonnull)mediaLabel mediaTheme1:(NSString * _Nonnull)mediaTheme1 mediaTheme2:(NSString * _Nonnull)mediaTheme2 mediaTheme3:(NSString * _Nonnull)mediaTheme3 SWIFT_WARN_UNUSED_RESULT;
/// Remove a live video
/// \param mediaLabel video name
///
- (void)remove:(NSString * _Nonnull)mediaLabel;
...
SWIFT_CLASS("_TtC7Tracker5Media")
@interface Media : NSObject
/// Add a new medium
/// \param mediaLabel medium name
///
/// \param mediaType medium name
///
/// \param duration medium duration in seconds
///
///
/// returns:
/// the new medium instance
- (Medium * _Nonnull)add:(NSString * _Nonnull)mediaLabel mediaType:(NSString * _Nonnull)mediaType duration:(NSInteger)duration SWIFT_WARN_UNUSED_RESULT;
/// Add a new medium
/// \param mediaLabel medium name
///
/// \param mediaTheme1 chapter1 label
///
/// \param mediaType medium type
///
/// \param duration medium duration in seconds
///
///
/// returns:
/// the new medium instance
- (Medium * _Nonnull)add:(NSString * _Nonnull)mediaLabel mediaTheme1:(NSString * _Nonnull)mediaTheme1 mediaType:(NSString * _Nonnull)mediaType duration:(NSInteger)duration SWIFT_WARN_UNUSED_RESULT;
/// Add a new medium
/// \param mediaLabel medium name
///
/// \param mediaTheme1 chapter1 label
...
/// returns:
/// the new medium instance
- (Medium * _Nonnull)add:(NSString * _Nonnull)mediaLabel mediaTheme1:(NSString * _Nonnull)mediaTheme1 mediaTheme2:(NSString * _Nonnull)mediaTheme2 mediaType:(NSString * _Nonnull)mediaType duration:(NSInteger)duration SWIFT_WARN_UNUSED_RESULT;
/// Add a new medium
/// \param mediaLabel medium name
///
/// \param mediaTheme1 chapter1 label
...
/// returns:
/// the new medium instance
- (Medium * _Nonnull)add:(NSString * _Nonnull)mediaLabel mediaTheme1:(NSString * _Nonnull)mediaTheme1 mediaTheme2:(NSString * _Nonnull)mediaTheme2 mediaTheme3:(NSString * _Nonnull)mediaTheme3 mediaType:(NSString * _Nonnull)mediaType duration:(NSInteger)duration SWIFT_WARN_UNUSED_RESULT;
/// Remove a medium
/// \param mediaLabel medium name
///
- (void)remove:(NSString * _Nonnull)mediaLabel SWIFT_DEPRECATED_MSG("", "remove(mediaLabel:)");
/// Remove all media
- (void)removeAll;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
...
@property (nonatomic, strong) Media * _Nonnull media;
/// List of medias attached to this player
@property (nonatomic, strong) LiveMedia * _Nonnull liveMedia;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC7Tracker6Medium")
@interface Medium : RichMedia
@end

@class MvTestingVars;

/// Wrapper class to manage SalesTracker Order feature
SWIFT_CLASS("_TtC7Tracker9MvTesting")
@interface MvTesting : BusinessObject
/// Test
@property (nonatomic, copy) NSString * _Nonnull test;
/// WaveId
@property (nonatomic) NSInteger waveId;
/// WaveId
@property (nonatomic, copy) NSString * _Nonnull creation;
/// Custom variables
@property (nonatomic, strong) MvTestingVars * _Nonnull variables;
/// Send
- (void)send;
@end
...
SWIFT_CLASS("_TtC7Tracker12MvTestingVar")
@interface MvTestingVar : NSObject
/// Custom var variable
...
SWIFT_CLASS("_TtC7Tracker13MvTestingVars")
@interface MvTestingVars : NSObject
/// Add a custom var
/// \param variable var variable
///
/// \param version var version
///
///
/// returns:
/// the MvTestingVar instance
- (MvTestingVar * _Nonnull)add:(NSString * _Nonnull)variable version:(NSString * _Nonnull)version SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


/// Wrapper class to manage MvTestings instances
SWIFT_CLASS("_TtC7Tracker10MvTestings")
@interface MvTestings : NSObject
/// Add an mvtesting
/// \param test mvtesting test
///
/// \param waveId mvtesting wave id
///
/// \param creation mvtesting creation
///
///
/// returns:
/// MvTesting instance
- (MvTesting * _Nonnull)add:(NSString * _Nonnull)test waveId:(NSInteger)waveId creation:(NSString * _Nonnull)creation SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
///   </li>
/// </ul>
typedef SWIFT_ENUM(NSInteger, OnAppAdAction, closed) {
  OnAppAdActionView = 0,
...
SWIFT_CLASS("_TtC7Tracker15PaymentCheckout")
@interface PaymentCheckout : Event
/// Cart property
@property (nonatomic, strong) ECommerceCart * _Nonnull cart;
/// Shipping property
@property (nonatomic, strong) ECommerceShipping * _Nonnull shipping;
...
SWIFT_CLASS("_TtC7Tracker16PaymentCheckouts")
@interface PaymentCheckouts : EventsHelper
/// Add payment checkout event tracking
///
/// returns:
/// PaymentCheckout instance
- (PaymentCheckout * _Nonnull)add SWIFT_WARN_UNUSED_RESULT;
@end
...
/// Actions
typedef SWIFT_ENUM(NSInteger, ProductAction, closed) {
  ProductActionView = 0,
};
...
@interface PublisherImpression : Publisher
/// Create a PublisherImpression with a campaignId
/// \param campaignId campaign identifier
///
- (nonnull instancetype)initWithCampaignId:(NSString * _Nonnull)campaignId OBJC_DESIGNATED_INITIALIZER SWIFT_DEPRECATED_MSG("useless constructor");
- (void)sendImpression;
- (void)sendTouch;
@end
...
SWIFT_CLASS("_TtC7Tracker13RemoveProduct")
@interface RemoveProduct : Event
/// Product property
@property (nonatomic, strong) ECommerceProduct * _Nonnull product;
/// Cart property
@property (nonatomic, strong) ECommerceCart * _Nonnull cart;
...
SWIFT_CLASS("_TtC7Tracker14RemoveProducts")
@interface RemoveProducts : EventsHelper
/// Add remove product event tracking
///
/// returns:
/// RemoveProduct instance
- (RemoveProduct * _Nonnull)add SWIFT_WARN_UNUSED_RESULT;
@end
...
@interface SelfPromotionImpression : SelfPromotion
/// Constructor
/// \param adId Advertising identifier
///
- (nonnull instancetype)initWithAdId:(NSInteger)adId OBJC_DESIGNATED_INITIALIZER SWIFT_DEPRECATED_MSG("useless constructor");
- (void)sendImpression;
- (void)sendTouch;
@end
...
///   </li>
/// </ul>
@property (nonatomic, readonly, strong) Locations * _Nonnull locations SWIFT_DEPRECATED_MSG("location is now only available as a screen object property (> 2.5.0).");
...
@property (nonatomic, readonly, strong) ECommerce * _Nonnull ecommerce;
/// Return Events instance
@property (nonatomic, readonly, strong) Events * _Nonnull events;
...
///   </li>
/// </ul>
@property (nonatomic, readonly, strong) CustomVars * _Nonnull customVars SWIFT_DEPRECATED_MSG("customVars is now only available as a screen object property (> 2.5.0).");
...
///   </li>
/// </ul>
@property (nonatomic, readonly, strong) InternalSearches * _Nonnull internalSearches SWIFT_DEPRECATED_MSG("internalSearch is now only available as a screen object property (> 2.5.0).");
...
///   </li>
/// </ul>
@property (nonatomic, readonly, strong) CustomTreeStructures * _Nonnull customTreeStructures SWIFT_DEPRECATED_MSG("customTreeStructures is now only available as a screen object property (> 2.5.0).");
/// Return MediaPlayers instance
@property (nonatomic, readonly, strong) MediaPlayers * _Nonnull mediaPlayers;
/// Campaign Tracking. Campaign is now available as a screen object property but you may use this method for notification tracking
@property (nonatomic, readonly, strong) MvTestings * _Nonnull mvTestings;
/// SDK Version
...
///
- (nonnull instancetype)initWithConfiguration:(NSDictionary<NSString *, NSString *> * _Nonnull)configuration;
...
/// \param completionHandler called when the operation has been done
///
- (void)setSecureModeEnabled:(BOOL)enabled sync:(BOOL)sync completionHandler:(void (^ _Nullable)(BOOL))completionHandler SWIFT_DEPRECATED_MSG("since 2.16.0, secure mode forced");
...
/// \param completionHandler called when the operation has been done
///
- (void)setIgnoreLimitedAdTrackingEnabled:(BOOL)enabled sync:(BOOL)sync completionHandler:(void (^ _Nullable)(BOOL))completionHandler;
...
/// \param completionHandler called when the operation has been done
///
- (void)setSendHitWhenOptOutEnabled:(BOOL)enabled sync:(BOOL)sync completionHandler:(void (^ _Nullable)(BOOL))completionHandler;
...
/// \param completionHandler called when the operation has been done
///
- (void)setSendOnlyWhenAppActive:(BOOL)enabled sync:(BOOL)sync completionHandler:(void (^ _Nullable)(BOOL))completionHandler SWIFT_DEPRECATED_MSG("use setSendOnApplicationState instead");
/// Set new pixel path
...
- (NSDictionary<NSString *, id> * _Nonnull)getLifecycleMetrics SWIFT_WARN_UNUSED_RESULT;
/// Get last crash informations
///
/// returns:
/// the map which contains lifecycle metrics computed by the SDK
- (NSDictionary<NSString *, id> * _Nonnull)getCrashInformation SWIFT_WARN_UNUSED_RESULT;
/// Disable user identification.
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) BOOL optOut SWIFT_DEPRECATED_MSG("Use ATInternet.optOut instead");)
+ (BOOL)optOut SWIFT_WARN_UNUSED_RESULT;
+ (void)setOptOut:(BOOL)newValue;
/// Disable user identification.
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) BOOL doNotTrack SWIFT_DEPRECATED_MSG("Use ATInternet.optOut instead");)
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull SendOnlyWhenAppActive SWIFT_DEPRECATED_MSG("Use 'sendOnApplicationState' property instead");)
+ (NSString * _Nonnull)SendOnlyWhenAppActive SWIFT_WARN_UNUSED_RESULT;
/// Allowed states to send hits
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull SendOnApplicationState;)
+ (NSString * _Nonnull)SendOnApplicationState SWIFT_WARN_UNUSED_RESULT;
/// Automatic send sales tracker hits from sales insights data (Sales Insights)
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull AutoSalesTracker;)
+ (NSString * _Nonnull)AutoSalesTracker SWIFT_WARN_UNUSED_RESULT;
/// collect domain (events only)
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull CollectDomain;)
+ (NSString * _Nonnull)CollectDomain SWIFT_WARN_UNUSED_RESULT;
/// ignore limited ad tracking
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull IgnoreLimitedAdTracking;)
+ (NSString * _Nonnull)IgnoreLimitedAdTracking SWIFT_WARN_UNUSED_RESULT;
/// send hits when opt out
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull SendHitWhenOptOut;)
+ (NSString * _Nonnull)SendHitWhenOptOut SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC7Tracker23TransactionConfirmation")
@interface TransactionConfirmation : Event
/// Products list
@property (nonatomic, copy) NSArray<ECommerceProduct *> * _Nonnull products;
/// Cart property
@property (nonatomic, strong) ECommerceCart * _Nonnull cart;
...
SWIFT_CLASS("_TtC7Tracker24TransactionConfirmations")
@interface TransactionConfirmations : EventsHelper
/// Add transaction confirmation event tracking
///
/// returns:
/// TransactionConfirmation instance
- (TransactionConfirmation * _Nonnull)add SWIFT_WARN_UNUSED_RESULT;
/// Add transaction confirmation event tracking
/// \param screenLabel a screen label
///
///
/// returns:
/// TransactionConfirmation instance
- (TransactionConfirmation * _Nonnull)addWithScreenLabel:(NSString * _Nullable)screenLabel SWIFT_WARN_UNUSED_RESULT;
/// Add transaction confirmation event tracking
/// \param screen a screen instance
///
///
/// returns:
/// TransactionConfirmation instance
- (TransactionConfirmation * _Nonnull)addWithScreen:(Screen * _Nullable)screen SWIFT_WARN_UNUSED_RESULT;
@end


/// Wrapper class for UpdateCart event tracking (SalesInsight)
SWIFT_CLASS("_TtC7Tracker10UpdateCart")
@interface UpdateCart : Event
/// Cart property
@property (nonatomic, strong) ECommerceCart * _Nonnull cart;
@end
...
/// Wrapper class to manage UpdateCart event instances
SWIFT_CLASS("_TtC7Tracker11UpdateCarts")
@interface UpdateCarts : EventsHelper
/// Add update cart event tracking
///
/// returns:
/// UpdateCart instance
- (UpdateCart * _Nonnull)add SWIFT_WARN_UNUSED_RESULT;
@end
...
- (Video * _Nonnull)add:(NSString * _Nonnull)mediaLabel duration:(NSInteger)duration SWIFT_WARN_UNUSED_RESULT;
/// Add a new video
...
/// returns:
/// the new video instance
- (Video * _Nonnull)add:(NSString * _Nonnull)name chapter1:(NSString * _Nonnull)chapter1 duration:(NSInteger)duration SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_MSG("", "add(mediaLabel:mediaTheme1:duration:)");
/// Add a new video
/// \param mediaLabel video name
///
/// \param mediaTheme1 chapter1 label
...
/// returns:
/// the new video instance
- (Video * _Nonnull)add:(NSString * _Nonnull)mediaLabel mediaTheme1:(NSString * _Nonnull)mediaTheme1 duration:(NSInteger)duration SWIFT_WARN_UNUSED_RESULT;
/// Add a new video
/// \param name video name
///
/// \param chapter1 chapter1 label
...
/// returns:
/// the new video instance
- (Video * _Nonnull)add:(NSString * _Nonnull)name chapter1:(NSString * _Nonnull)chapter1 chapter2:(NSString * _Nonnull)chapter2 duration:(NSInteger)duration SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_MSG("", "add(mediaLabel:mediaTheme1:mediaTheme2:duration:)");
/// Add a new video
/// \param mediaLabel video name
///
/// \param mediaTheme1 chapter1 label
...
/// returns:
/// the new video instance
- (Video * _Nonnull)add:(NSString * _Nonnull)mediaLabel mediaTheme1:(NSString * _Nonnull)mediaTheme1 mediaTheme2:(NSString * _Nonnull)mediaTheme2 duration:(NSInteger)duration SWIFT_WARN_UNUSED_RESULT;
/// Add a new video
/// \param name video name
///
/// \param chapter1 chapter1 label
...
/// returns:
/// the new video instance
- (Video * _Nonnull)add:(NSString * _Nonnull)name chapter1:(NSString * _Nonnull)chapter1 chapter2:(NSString * _Nonnull)chapter2 chapter3:(NSString * _Nonnull)chapter3 duration:(NSInteger)duration SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_MSG("", "addWithMediaLabel:mediaTheme1:mediaTheme2:mediaTheme3:duration:");
/// Add a new video
/// \param mediaLabel video name
///
/// \param mediaTheme1 chapter1 label
...
/// returns:
/// the new video instance
- (Video * _Nonnull)addWithMediaLabel:(NSString * _Nonnull)mediaLabel mediaTheme1:(NSString * _Nonnull)mediaTheme1 mediaTheme2:(NSString * _Nonnull)mediaTheme2 mediaTheme3:(NSString * _Nonnull)mediaTheme3 duration:(NSInteger)duration SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_MSG("same method without first parameter named is available");
/// Add a new video
/// \param mediaLabel video name
///
/// \param mediaTheme1 chapter1 label
...
/// returns:
/// the new video instance
- (Video * _Nonnull)add:(NSString * _Nonnull)mediaLabel mediaTheme1:(NSString * _Nonnull)mediaTheme1 mediaTheme2:(NSString * _Nonnull)mediaTheme2 mediaTheme3:(NSString * _Nonnull)mediaTheme3 duration:(NSInteger)duration SWIFT_WARN_UNUSED_RESULT;
/// Remove a video
/// \param mediaLabel video name
///
- (void)remove:(NSString * _Nonnull)mediaLabel SWIFT_DEPRECATED_MSG("", "remove(mediaLabel:)");
